...
interface Crypto {
    ...
    companion object Default : Crypto {
        override suspend fun encrypt(input: ByteArray) = input
        override suspend fun encrypt(input: String) = input
        override suspend fun decrypt(input: ByteArray) = input
        override suspend fun decrypt(input: String) = input
