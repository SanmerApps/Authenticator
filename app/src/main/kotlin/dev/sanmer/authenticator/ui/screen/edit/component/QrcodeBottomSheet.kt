...
fun QrcodeBottomSheet(
    onClose: () -> Unit,
    qrcode: Result<Pair<String, ImageBitmap>>
) = ModalBottomSheet(
    ...
    Column(
        ...
        qrcode.onSuccess { (content, bitmap) ->
            Image(
                bitmap = bitmap,
            ...
            Button(
                onClick = { scope.launch { clipboard.setSensitiveText(content) } },
                modifier = Modifier.fillMaxWidth()
            ) {
                Text(text = stringResource(R.string.token_copy))
            }
        }.onFailure {
            Finished(
